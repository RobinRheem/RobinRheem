...
require('packer').startup(function(use)
  ...
  use { 'nvim-telescope/telescope-packer.nvim', requires = { 'wbthomason/packer.nvim', 'nvim-telescope/telescope.nvim' } }
...
map('n', '<leader>w', "<cmd>WhichKey<cr>", { noremap = true })
map('n', '<leader><leader>', [[<cmd>lua require('telescope.builtin').buffers()<CR>]], { noremap = true })
map('n', '<leader>fo', [[<cmd>lua require('telescope.builtin').find_files({previewer = false})<CR>]], { noremap = true })
map('n', '<leader>fi', [[<cmd>lua require('telescope.builtin').live_grep()<CR>]], { noremap = true })
map('n', '<leader>ff', [[<cmd>lua require('telescope.builtin').current_buffer_fuzzy_find()<CR>]], { noremap = true, silent = true })
map('n', '<leader>fc', [[<cmd>lua require('telescope.builtin').commands()<CR>]], { noremap = true, silent = true })
map('n', '<leader>ch', [[<cmd>lua require('telescope.builtin').command_history()<CR>]], { noremap = true, silent = true })
map('n', '<leader>h', [[<cmd>lua require('telescope.builtin').search_history()<CR>]], { noremap = true, silent = true })
map('n', '<leader>k', [[<cmd>lua require('telescope.builtin').keymaps()<CR>]], { noremap = true, silent = true })
map('n', '<leader>?', [[<cmd>lua require('telescope.builtin').oldfiles()<CR>]], { noremap = true, silent = true })
map('n', '<leader>ts', [[<cmd>lua require('telescope.builtin').treesitter()<CR>]], { noremap = true, silent = true })
map('n', '<leader>m', [[<cmd>lua require('telescope.builtin').man_pages()<CR>]], { noremap = true, silent = true })
